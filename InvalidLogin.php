...
<div class="container">
    ...
    <div class="alert alert-danger" role="alert">
        <a href="#loginModal" data-toggle="modal" class="alert-link" style="font-size: 20px;">The username already exists, click here to log into your account!</a>
</div>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p></p><br> Please contact <a mailto:href="rj.festival.2015@gmail.com">rj.festival.2015@gmail.com</a> for any other inquiries.</p>
        </div>
