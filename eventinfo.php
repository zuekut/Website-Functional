	...
	<div class="row clearfix" id="divprops">
		<div class="col-md-12 column" >
            ...
            <div>
                ...
                <p>
                    Checkout the full lineup and timetable <a href="lineup.html"><b>here</b></a>
                ...
                <img src="img/campingmap.jpg" style="right: 0; position: absolute; top: 100px; width: 45%;">
            </div>   
		</div>
<div class="container" style="width: 100%">
    <div id="content">
        <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
            <li role="presentation" class="active"><a href="#access" data-toggle="tab">Access to Wood Festival</a></li>
            <li role="presentation"><a href="#route" data-toggle="tab">How to get there?</a></li>
            <li role="presentation"><a href="#atfestivalsite" data-toggle="tab">At the festival site</a></li>
            <li role="presentation"><a href="#rules" data-toggle="tab">Rules & Regulations</a></li>
            <li role="presentation"><a href="#disability" data-toggle="tab">People with disability</a></li>
        </ul>
        <div id="my-tab-content" class="tab-content">
            ...
            <div class="tab-pane fade" id="route">
                ...
                <p>Navigate us to there master</p>
            </div>
